...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
        <div class="form-group"> 
            <br><label for="correo">{{ __('Correo eletrónico:') }}</label>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
        <div class="form-group"> 
            <br><label for="tipo_doc">Tipo de documento: </label><br>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
        <div class="form-group"> 
        <br><label for="numero_doc">Número de documento:</label>
            <input type="number" name="numero_doc" id="numero_doc" class="form-control" placeholder="Número de documento">
        </div> 
    </div> 
