                ...
                <div class="card-body">
                    <form method="POST" action="rusuario" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$ultimaP->nombre}}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" name="avatar" id="avatar" value="default.png">
                            </div>
                        </div>
